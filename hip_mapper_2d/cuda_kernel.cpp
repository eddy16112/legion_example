...
typedef FieldAccessor<READ_WRITE,int,2,coord_t,Realm::AffineAccessor<int,2,coord_t> > AccessorRWint;
                     ...
                     Context ctx, Runtime *runtime)
{
  ...
  hipLaunchKernelGGL((init_field_task_kernel), dim3(blocks), dim3(threadsPerBlock), 0, hipGetTaskStream(), ptr_x);
  hipLaunchKernelGGL((init_field_task_kernel_acc), dim3(blocks), dim3(threadsPerBlock), 0, hipGetTaskStream(), acc_x);
